...
- 협동게임이라 **점수를 서로 다투지 않습니다.** 엔딩이 갈리는 축이 「누가 이겼나」가
  아니라 「어디까지 풀었나」가 됩니다
...
ID = "combo"
TITLE = "COMBO"
SUBTITLE = "두 번째 게임"      # 라벨에서 제목 아래 한 줄. 제목을 되풀이하지 않습니다
META = {
    "title": TITLE, "subtitle": SUBTITLE,
    # 잠긴 카드에서도 이 한 줄은 보입니다. 다음 게임이 무엇인지 궁금해질 만큼만 적습니다 —
    # 기믹도 진상도 여기서 말하지 않습니다.
    "blurb": "같은 세계, 다른 게임. 아직 열리지 않았습니다.",
    "players": "3인",
    "tone": "세계관 퍼즐 · 협동 방탈출",
    "difficulty": "★★",
    "tagline": "곧 열립니다",
