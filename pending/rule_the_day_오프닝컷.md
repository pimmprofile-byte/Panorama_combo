...
| 6 | `spear` | `rule_the_day_opening_spear.webp` | 거꾸로 박힌 삼지창 |
...
> 판을 여는 한 장입니다. **소리를 그림으로** 그려야 합니다 — 소리를 낸 사람은
> 아직 안 보입니다. 놀란 새와 흔들린 공기만 있습니다.
...
> 마을이 어떤 곳인지 처음이자 마지막으로 보여주는 한 장입니다. **이어 붙인 티**가
> 나야 합니다 — 나무집 옆에 흰 패널, 그 너머에 박힌 잠수함.
...
> 문 앞에서 멈춘 시선입니다. **안은 아직 안 보여줍니다** — 문틈으로 새는 초록만
> 보입니다. 그 초록이 이 판 유일한 악센트입니다.
...
> 말하는 사람이 처음 나오는 컷입니다. **감정이 없다는 것**이 요점입니다 —
> 사람이 죽어 있는 방 안에서 도와달라고 부르는데 표정이 평범합니다.
...
> 이 판의 사건 그 자체입니다. **피가 없습니다.** 각진 파편과 떠 있는 알갱이뿐입니다.
> 사람이었다는 것은 알아볼 수 있어야 하지만, 얼굴은 남아 있으면 안 됩니다.
...
> 흉기 한 장입니다. **거꾸로**라는 것이 단서입니다 — 갈래가 위가 아니라 아래를
> 향한 채 박혀 있습니다.
...
> 첫 수수께끼가 여기 있습니다. **무엇인지는 안 보여줍니다** — 모서리 하나와
> 그것이 눌린 자국만 보입니다.
...
> 세상이 잠기는 컷입니다. **문도 벽도 아닙니다** — 마을 바깥쪽 공기가 굳어 버린
> 것처럼 보여야 합니다.
...
> 마지막 컷이자 판의 선언입니다. **셋 다 한 프레임에**, 서로를 보고 있고,
> 아무도 붙어 서 있지 않습니다.
