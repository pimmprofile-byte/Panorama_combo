...
## 0. 왜 픽셀아트인가 — 이게 이 게임의 설계다

이 게임의 진상은 **「여기가 게임 속 세상」** 입니다.
...
그리고 게임이 끝나고 나면 그 화풍이 **처음부터 깔려 있던 복선**이 됩니다.
「아, 우리는 처음부터 게임 화면을 보고 있었구나.」 감춘 것이 아니라 **눈앞에 두고도
못 알아보게** 한 것이고, 그게 이 게임이 하려는 일입니다.
...
- **배역 색** — 사람이 나오는 컷에서 림라이트로만 아주 조금.
  데이빗 `#2CD8FF` · 데이먼 `#FF5FD3` · 데이지 `#FF8A3D`
...
★ **앞머리에는 판형과 구도를 안 적습니다.** 앞머리는 게임 전체의 «화풍»이고,
...
게임을 여는 아홉 장입니다. **한 묶음이 곧 한 시퀀스**이고, 뒤에 붙는 시퀀스는
...
**게임을 여는 한 장입니다. **소리를 그림으로** 그려야 합니다 — 소리를 낸 사람은 아직 안 보입니다. 놀란 새와 흔들린 공기만 있습니다.**
...
**문 앞에서 멈춘 시선입니다. **안은 아직 안 보여줍니다** — 문틈으로 새는 초록만 보입니다. 그 초록이 이 게임 유일한 악센트입니다.**
...
**이 게임의 사건 그 자체입니다. **피가 없습니다.** 각진 파편과 떠 있는 알갱이뿐입니다. 사람이었다는 것은 알아볼 수 있어야 하지만, 얼굴은 남아 있으면 안 됩니다.**
...
**흉기 한 장입니다. 이 게임에서 «가장 정해진» 물건이라 생김새를 어기면 안 됩니다.**
...
**마지막 컷이자 게임의 선언입니다. **셋 다 한 프레임에**, 서로를 보고 있고, 아무도 붙어 서 있지 않습니다.**
...
- 9번 컷에서 셋이 붙어 서 있으면 **리젝**. 이 게임은 서로를 의심하는 자리다
